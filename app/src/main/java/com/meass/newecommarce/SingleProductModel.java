...
public class SingleProductModel implements Serializable {
    ...
    private String useremail,usermobile,prname,prprice,
            primage,prdesc,message_header,message_body,vendor_email,vendor_phone;

    public SingleProductModel() {
    }

    public SingleProductModel(int prid, int no_of_items,
                              String useremail, String usermobile,
                              String prname, String prprice, String primage, String prdesc,
                              String message_header, String message_body,
                              String vendor_email, String vendor_phone) {
        this.prid = prid;
