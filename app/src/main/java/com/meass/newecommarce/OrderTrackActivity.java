...
FirebaseAuth firebaseAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delivary_date=getIntent().getStringExtra("delivary_date");
        progressHUD = KProgressHUD.create(OrderTrackActivity.this);
    ...
    private void populateRecyclerView() {
        ...
        final Query bottomInvoiceQuery =firebaseFirestore.collection("Orders_Check").document("01880921069@gmail.com")
                .collection("Admin_Check").document(snapshotId)
                .collection("Items");
        ...
        adapter = new FirestoreRecyclerAdapter<SingleProductModel, OrderTrackActivity.MovieViewHolder>(response) {
            @Override
            protected void onBindViewHolder(@NonNull OrderTrackActivity.MovieViewHolder viewHolder, final int position, @NonNull final SingleProductModel model) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final FancyAlertDialog.Builder alert = new FancyAlertDialog.Builder(OrderTrackActivity.this)
                                .setBackgroundColor(R.color.whiteCardColor)
                                .setimageResource(R.drawable.send)
                                .setTextTitle("Order")
                                .setCancelable(true)
                                .setTextSubTitle("Are you want to placed order to vendor?")
                                ...
                                .setNegativeButtonText("Send to vendor")
                                .setOnNegativeClicked(new FancyAlertDialog.OnNegativeClicked() {
                                    @Override
                                    public void OnClick(View view, Dialog dialog) {
                                        dialog.dismiss();
                                        progress_check();
                                        String vendor_email=model.getVendor_email();
                                        String proimage=model.getPrimage();
                                        String proname=model.getPrname();
                                        String proprice=model.getPrprice();
                                        String desc=model.getPrdesc();
                                        String uuid= UUID.randomUUID().toString();
                                        aaaa=model.getVendor_phone();
                                        textSend_user();
                                        Product_vendor product_vendor=new Product_vendor(vendor_email,proimage,proname,
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            progressHUD.dismiss();
                                                            Toasty.success(getApplicationContext(),"Product send to vendor",Toast.LENGTH_SHORT,true).show();
                                                        }
                                                    }
                                                });
    ...
    private void textSend_user() {
        int permission= ContextCompat.checkSelfPermission(OrderTrackActivity.this, Manifest.permission.SEND_SMS);
    ...
    private void sending() {
        ...
        /// String phoneNo = "01316356332";
       /* String sms = sm333s;

        try {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage(phoneNo, null, sms, null, null);
            Toasty.success(Payment_Activity.this,"Message Sent",Toast.LENGTH_SHORT,true).show();;
            ...
            e.printStackTrace();*/
        String phoneNo = aaaa;
        String sms = "আপনার একটি অর্ডার এসেছে,অনুরোধ করে অ্যাপসে প্রবেশ করুন";

        try {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage(phoneNo, null, sms, null, null);
            Toast.makeText(getApplicationContext(), "SMS Sent to "+aaaa,
                    Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Toast.makeText(getApplicationContext(),
                    "SMS faild, please try again later!",
